...
export default function PlayerCard({ player, isStarter, onClick, delay = 0 }) {
  ...
  return (
    <div
      ...
      className="cursor-pointer select-none focus:outline-none focus-visible:ring-2 focus-visible:ring-miami-green focus-visible:ring-offset-2 focus-visible:ring-offset-card-bg"
      style={{
    ...
    >
      <div
        className={`relative overflow-hidden rounded-[10px] ${isStarter ? 'w-[100px] border-2 border-miami-green shadow-[0_4px_12px_rgba(0,0,0,0.6)]' : 'w-[90px] border border-[#2a2a2a] shadow-[0_2px_8px_rgba(0,0,0,0.5)]'} bg-card-bg ${hovered ? 'shadow-[0_8px_20px_rgba(26,77,46,0.5),0_0_15px_rgba(26,77,46,0.3)]' : ''} ${isStarter ? 'opacity-100' : 'opacity-90'}`}
      >
        <div className="bg-miami-green px-2 py-1.5 relative">
        ...
        {hovered && <div className="absolute inset-0 pointer-events-none bg-miami-green/15" />}
      </div>
